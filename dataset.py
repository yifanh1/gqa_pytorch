...
class GQA(Dataset):
    def __init__(self, root, split='train', transform=None):
        with open(f'data/gqa_{split}_balanced.pkl', 'rb') as f:
    ...
    def __getitem__(self, index):
        ...
        imgfilename = ''.join([imgid, '.jpg'])
        im = Image.open(os.path.join(self.root,'images', imgfilename)).convert('RGB')
        im = self.transform(im)
        return im, question, loq, answer
